        ...
        <div className="container mx-auto px-4 relative z-10 h-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center min-h-[500px] md:min-h-[550px]">
            ...
            <div className="text-center lg:text-left py-12">
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-shadow-lg leading-tight">
                Business Signs
              </h2>
              <p className="text-2xl md:text-3xl text-white/90 text-shadow">Design | Production | Installation</p>
            </div>
            ...
            <div className="relative lg:absolute lg:right-8 lg:top-1/2 lg:-translate-y-1/2 lg:w-[380px] xl:w-[420px]">
              <div className="bg-primary rounded-t-lg overflow-hidden shadow-2xl">
                <div className="bg-primary py-5 px-6">
                  <h3 className="text-xl md:text-2xl font-bold text-primary-foreground text-center tracking-wide">GET A FREE QUOTE</h3>
                </div>
                <div className="bg-white p-6 md:p-8">
                  <QuoteForm variant="hero" />
                </div>
                <div className="bg-primary py-5 px-6 text-center">
                  <p className="text-sm font-bold text-primary-foreground mb-2 tracking-wide">RATED 5.0 STARS</p>

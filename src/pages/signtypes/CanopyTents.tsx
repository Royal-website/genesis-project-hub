  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>On top of that, canopy tents are the only promotional tool of their kind. They provide shelter as well as an area for activity, all while effectively promoting your business.</p>
      </ContentSection>

      <ContentSection title="Functional & Attractive" imagePosition="left">
        ...
        <p>Because they are tall and easily seen from far distances, canopy tents can impactfully display graphics portraying a business brand. They also serve as wayfinding tools because their presence and height make them look a lot like landmarks that people can use as a location reference.</p>
      </ContentSection>
      ...
      <ContentSection title="Pop-Up Canopy Tents">
        ...
        <p>You may think that pop-up canopy tents, being temporary-use and lightweight tools, are also not very durable. But with Royal Signs & Awnings, rest assured that you would get tough and long-lasting pop-up tents, whether they are made of steel, stainless steel, or aluminum.</p>
      </ContentSection>
      ...
      <ContentSection title="Full-Service Sign Company">
        ...
        <p>The excellent services we provide are managed by our highly trained experts. We have graphic designers that take care of every visual design concept that we put on signage. We have installation and manufacturing specialists as well as engineers that ensure the technical quality of our products.</p>
      </ContentSection>

...
export default function ChannelLetters() {
  return (
    <UniversalPageTemplate
      ...
      heroImage="/images/signtypes/channel-letters/channel-letter-building.jpg"
      breadcrumbs={[
        { name: "Home", path: "/" },
    ...
    >
      <ContentSection
        ...
        image="/images/signtypes/channel-letters/channel-letter-building.jpg"
      ...
      >
        ...
        <p className="mb-4">The flexibility and versatility of a channel letter sign allows them to be customized to meet any brand guidelines or personal design choices. Whether you would like an illuminated sign, flat dimensional letters, or a completely <Link to="/custom-signs" className="text-accent hover:underline">custom sign</Link>, we can create the perfect sign for you.</p>
      ...
      <ContentSection 
        ...
        image="/images/signtypes/channel-letters/storefront-channel-letters.jpg"
        imageAlt="Custom Channel Letter Sign"
        imagePosition="left"
      >
        <p className="mb-4">Our most frequent <Link to="/storefront-signs" className="text-accent hover:underline">storefront sign</Link> request is for a channel letter sign. Channel letters are 3-dimensional signs, created through forming individual cut metal elements, such as letters, numbers, symbols, or images, that are perfectly aligned and secured to a backing frame, such as a raceway sign, or can even be flush-mounted directly to your building. The channel itself is covered with a durable acrylic top, available in any color or transparency level for a completely customized look.</p>
        <p className="mb-4">You can spell out your name, slogan, and even include your logo in this type of sign. We have a wide variety of color, size, font, and style options, making this an easy to customize sign for any business. Channels can also be hand-formed to create just about any image or icon, allowing you to add any image or custom fonts to your sign.</p>
      ...
      >
        <p className="mb-4"><Link to="/dimensional-letters" className="text-accent hover:underline">Dimensional letter signs</Link> are similar to channel letter signs in that they both consist of individually created elements. Where channel letters have an empty channel inside allowing for illumination, dimensional letters are cut from solid sheets of acrylic, metal, or other material. There are many different options for sizes, styles, and fonts, as well as variances in material thickness, so you can control how dimensional your sign looks, from almost flat to several inches deep.</p>
        ...
        <p className="font-semibold">These signs are ideal for restaurants, retail stores, offices, malls, manufacturing, and are even a great option for <Link to="/indoor-signs" className="text-accent hover:underline">indoor signs</Link> or <Link to="/lobby-signs" className="text-accent hover:underline">lobby signs</Link>.</p>
      </ContentSection>
      ...
      >
        ...
        <p className="font-semibold"><Link to="/lighted-signs" className="text-accent hover:underline">Lighted signs</Link> are ideal for nightclubs, theaters, restaurants, bars, coffee shops, comedy clubs, convenience stores, and gas stations, but can work well for any business that wants to set themselves apart.</p>
      </ContentSection>

  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>Royal Signs & Awnings is your local provider of professional business signs, with fast service and quality fabrication within your budget.</p>
      </ContentSection>

      <ContentSection title="Storefront Channel Letters" imagePosition="left">
        ...
        <p className="mb-4">The channel itself is covered with a durable acrylic top, available in any color or transparency level for a completely customized look. You can spell out your name, slogan, and even include your logo in this type of sign. We have a wide variety of color, size, font, and style options, making this an easy to customize sign for any business.</p>
        <p>Channel Letter Signs are most popular for retail stores, office buildings, grocery stores, malls, shopping centers, manufacturing facilities, schools, churches, and other organizations.</p>
      </ContentSection>
      ...
      <ContentSection title="Dimensional Letters">
        ...
        <p>These signs are ideal for restaurants, retail stores, offices, malls, manufacturing, and are even a great option for indoor signs or lobby signs.</p>
      </ContentSection>
      ...
      <ContentSection title="Backlit & Illuminated Channel Signs">
        ...
        <p>Lighted signs are ideal for nightclubs, theaters, restaurants, bars, coffee shops, comedy clubs, convenience stores, and gas stations, but can work well for any business that wants to set themselves apart.</p>
      </ContentSection>
